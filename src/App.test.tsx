...
import { DebouncedFunction } from './types/debounce';
...
describe('App Component', () => {
    beforeEach(() => {
        ...
        debounceMock.mockImplementation((fn: (...args: any[]) => any) => {
            const mockFn = jest.fn((...args: any[]) => fn(...args)) as unknown as DebouncedFunction<typeof fn>;
